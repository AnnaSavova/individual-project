...
export class AlgorithmPageComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //  //let alg: string = "spap-orig-egs";
    //  let alg:string = "spap-improved-egs";

    //  this.algorithmService.numberOfGroup1Agents = group1;
    //  this.algorithmService.numberOfGroup2Agents = group2;
    //  this.algorithmService.numberOfGroup3Agents = group3;
    ...
    //  this.playback.setAlgorithm(alg, group1, group2, undefined, group3);


    this.drawService.initialise();

    // (un)comment the line below to (disable)/enable working algorithm selection
    if (this.algorithmService.currentAlgorithm.id == "spap-orig-egs" || "spap-improved-egs") {
      this.playback.setAlgorithm(this.algorithmService.currentAlgorithm.id, this.algorithmService.numberOfGroup1Agents, this.algorithmService.numberOfGroup2Agents, undefined, this.algorithmService.numberOfGroup3Agents);
    } else {
